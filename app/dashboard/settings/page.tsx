...
export default function SettingsPage() {
  ...
  const inputStyle: any = { width: '100%', background: '#0a0a0f', border: '1px solid #2a2a3a', borderRadius: 10, padding: '0.75rem 1rem', color: '#f5f5f0', fontSize: '0.9rem', outline: 'none', fontFamily: 'inherit' }
