...
export default function SettingsPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0a0a0f', display: 'flex' }}>
      ...
      <main style={{ marginLeft: 240, flex: 1, padding: '2rem', maxWidth: 740 }}>
        ...
        <div style={sectionStyle}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1.25rem' }}><Globe size={18} color="#c9a84c" /><h2 style={{ fontWeight: 700, color: '#f5f5f0' }}>Language</h2></div>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem' }}>
            <div>
              ...
              <div style={{ fontSize: '0.85rem', color: '#9999aa' }}>3 generations included · Upgrade for unlimited access</div>
            </div>
            <button className="btn-gold" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}><CreditCard size={16} />Manage subscription</button>
          </div>
        </div>
