            ...
            <div key={project.id} className="glass-card" style={{ borderRadius: 16, overflow: 'hidden', transition: 'transform 0.2s' }}
              ...
              <div style={{ padding: '1.25rem' }}>
                ...
                <div style={{ display: 'flex', gap: '0.5rem' }}>
                  ...
                  <button style={{ padding: '0.4rem 0.75rem', borderRadius: 8, background: 'rgba(255,80,80,0.1)', border: 'none', color: '#ff8080', cursor: 'pointer', fontSize: '0.8rem' }}><Trash2 size={12} /></button>
                </div>
              </div>
            </div>
          ))}
          <Link href="/studio" style={{ textDecoration: 'none' }}>
            <div className="glass-card" style={{ borderRadius: 16, height: '100%', minHeight: 280, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '1rem', cursor: 'pointer', border: '2px dashed #2a2a3a', transition: 'border-color 0.2s' }}
