    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 420 }}>
        ...
        <div style={{
          ...
          textAlign: 'center', color: '#c9a84c', fontSize: '0.85rem',
        }}>
          ✦ Start with 3 free AI generations — no credit card required
        </div>

        <div className="glass-card" style={{ padding: '2.5rem', borderRadius: 20 }}>
          <h1 style={{
            fontWeight: 800, fontSize: '1.75rem', color: '#f5f5f0',
            marginBottom: '0.5rem', textAlign: 'center',
          }}>
            Create account
          </h1>
          <p style={{ color: '#9999aa', textAlign: 'center', marginBottom: '2rem' }}>
            Join thousands of designers using AI
          </p>

          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <div>
              <label style={{ display: 'block', color: '#9999aa', fontSize: '0.85rem', marginBottom: '0.5rem' }}>
                Name
              </label>
